##### OVEREXPRESSION VALIDATION SCREEN GROWTH CURVE ANALYSIS
##### Author : Saurin Parikh
##### Email  : dr.saurin.parikh@gmail.com
##### Date   : 03/18/2022 

source('/home/sbp29/R/Projects/adaptivefitness/scripts/translatome/tr_oe_val_ms_fit.R')
...
data.gc.res <- NULL
  for (c in unique(data.fit.all$condition)) {
    ...
    # save(data.pred, file = sprintf('/home/sbp29/R/Projects/adaptivefitness/output/translatome/pinning_artifact_correction/growth_curve_prediction/data.pred.cs.pos.%s.RData',c))
...
save.image(file = '/home/sbp29/R/Projects/adaptivefitness/output/translatome/pinning_artifact_correction/VALID_CS_GROWTH_DATA_ALL.RData')
